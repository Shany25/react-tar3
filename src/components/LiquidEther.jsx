...
// LiquidEther (Background Visual):
// This component is a purely visual, background “style” layer.
// It renders an interactive liquid ether effect using Three.js.
// --------------------------------
    ...
    useEffect(() => {
        ...
        class MouseClass {
            constructor() {
                ...
                this._hasInitializedDelta = false; // prevents a big “first move” spike
                this._maxDelta = 0.18; // clamp sudden jumps (tweakable)
                this.timer = null;
                this.container = null;
                this.docTarget = null;
            ...
            setCoords(x, y) {
                ...
                // On the very first interaction, sync the previous coords to avoid a huge initial delta.
                if (!this._hasInitializedDelta) {
                    this.coords_old.copy(this.coords);
                    this.diff.set(0, 0);
                    this._hasInitializedDelta = true;
                }
            ...
            update() {
                ...
                // Clamp to avoid a visible “twitch” if the pointer jumps between frames.
                const len = this.diff.length();
                if (len > this._maxDelta) this.diff.multiplyScalar(this._maxDelta / len);
                this.coords_old.copy(this.coords);
